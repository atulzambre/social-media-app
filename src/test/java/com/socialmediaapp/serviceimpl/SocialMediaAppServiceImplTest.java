...
public class SocialMediaAppServiceImplTest {
    ...
    public void getNewFeedTest() {
        ...
        assertEquals("test 13 post 10", postModels.get(5).getPostContent());
        assertEquals("test 13 post 9", postModels.get(6).getPostContent());
        assertEquals("test 13 post 8", postModels.get(7).getPostContent());
        assertEquals("test 13 post 7", postModels.get(8).getPostContent());
        assertEquals("test 13 post 6", postModels.get(9).getPostContent());
        assertEquals("test 13 post 5", postModels.get(10).getPostContent());
        assertEquals("test 13 post 4", postModels.get(11).getPostContent());
        assertEquals("test 13 post 3", postModels.get(12).getPostContent());
        assertEquals("test 13 post 2", postModels.get(13).getPostContent());
